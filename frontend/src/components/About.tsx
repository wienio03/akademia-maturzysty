        ...
        <div id="about" className="flex justify-between items-center flex-col font-Montserrat text-black">
            ...
            <div className="lg:flex lg:flex-row lg:justify-between">
                <div className="py-20 px-32 text-center">
                    ...
                    <p className="flex-grow">Naszą misją jest dostarczenie najwyższej jakości usług edukacyjnych, które pomagają uczniom osiągnąć ich pełny potencjał. Wierzymy, że każdy ma zdolność do nauki, a naszą rolą jest wspieranie i inspirowanie do ciągłego rozwoju.</p>
                </div>
                <div className="py-20 px-32 text-center">
